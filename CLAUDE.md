...
| `packages/governance-core` | ✅ `node --test` — 17 tests over the cache-key helpers |
| `apps/legacy-estate` | ❌ none configured |

`npm test` at the root runs every workspace that has a suite — 199 tests. **What is still
